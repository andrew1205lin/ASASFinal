...
[F1_1, F2_1, F3_1, ~] = formant_analysis(wav_path1, 0.2);
[F1_2, F2_2, F3_2, ~] = formant_analysis(wav_path2, 0.2);
[F1_3, F2_3, F3_3, ~] = formant_analysis(wav_path3, 0.2);
[F1_4, F2_4, F3_4, ~] = formant_analysis(wav_path4, 0.2);
[F1_5, F2_5, F3_5, ~] = formant_analysis(wav_path5, 0.2);
...
f1f2_diagram(F1_1, F2_1, 0, 1, 'red'); %(f1,f2, save, overlay, color)
